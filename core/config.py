...
class Settings:
    ...
    PACKAGE_IMAGE_MAX_MB: int = int(os.getenv("PACKAGE_IMAGE_MAX_MB", "5"))
    USER_PDF_UPLOAD_MAX_MB: int = int(os.getenv("USER_PDF_UPLOAD_MAX_MB", "10"))
    # Multipart bodies; must be >= USER_PDF_UPLOAD_MAX_MB plus overhead (boundaries, fields).
    MAX_REQUEST_BODY_MB: int = int(os.getenv("MAX_REQUEST_BODY_MB", "25"))
