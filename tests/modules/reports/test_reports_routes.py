                ...
                DiagnosticTestGroupResponse(
                    ...
                    tests=[
                        HealthParameterResponse(
                            ...
                            unit="g/dL",
                            meaning=None,
                            low_risk_lower_range_male=13.0,
                            low_risk_higher_range_male=17.0,
                            low_risk_lower_range_female=12.0,
                            low_risk_higher_range_female=16.0,
                        ...
                        HealthParameterResponse(
                            ...
                            unit="mg/dL",
                            meaning=None,
                            low_risk_lower_range_male=70.0,
                            low_risk_higher_range_male=110.0,
                            low_risk_lower_range_female=70.0,
                            low_risk_higher_range_female=110.0,
                            causes_when_high=None,
                            causes_when_low=None,
                            effects_when_high=None,
                            effects_when_low=None,
...
async def test_get_risk_analysis_disease_query_returns_detail(
    ...
    assert response.json()["data"] == {
        ...
        "lifestyle_contribution": 12,
        "disease_percentile": 55,
        "low_risk_lower_range_male": None,
        "low_risk_higher_range_male": None,
        "moderate_risk_lower_range_male": None,
        "moderate_risk_higher_range_male": None,
        "high_risk_lower_range_male": None,
        "high_risk_higher_range_male": None,
        "low_risk_lower_range_female": None,
        "low_risk_higher_range_female": None,
        "moderate_risk_lower_range_female": None,
        "moderate_risk_higher_range_female": None,
        "high_risk_lower_range_female": None,
        "high_risk_higher_range_female": None,
        "causes_when_high": None,
        "causes_when_low": None,
        "effects_when_high": None,
        "effects_when_low": None,
